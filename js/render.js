...
const miToast = new bootstrap.Toast(toastElemento, {
  autohide: true,
  delay: 3000,
});
...
const render = {
  ...
  crearDetalleProducto: (producto, contenedor) => {
    ...
    row.innerHTML = `
      ...
      <div class="col-md-6 d-flex flex-column justify-content-center">
        ...
        <div class="d-grid">
          <button id="btn-agregar-detalle" class="btn btn-dark btn-lg rounded-pill btn-agregar" type="button">
            Agregar al carrito
          </button>
        </div>
      </div>
  ...
  mostrarToast: (mensaje, tipo = 'info') => {
    ...
    if (tipo == 'succes') {
      ...
      toastElemento.classList.add('text-bg-info');
    }
